...
@SequenceGenerator(name="ref_famille_exigence_seq",sequenceName="ref_famille_exigence_seq",allocationSize=1, initialValue = 1)
public class ReferentielFamilleExigence  extends BaseEntity     {
    ...
    @Id
    @Column(name = "id")
    @GeneratedValue(strategy =  GenerationType.SEQUENCE,generator = "ref_famille_exigence_seq")
      @Override
    public Long getId(){
        return this.id;
    }
